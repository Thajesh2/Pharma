...
<head>
  ...
  <style>
    body {
      background-image: url("c:\Users\admin\Downloads\bule.png");
...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-5">
        <img src="c:\Users\admin\Desktop\p11.jpg" class="img-fluid" alt="Pharmacy Image" width="2000" height="2000">
      </div>
      <div class="col-md-4">
        <img src="c:\Users\admin\Desktop\p22.jpg" class="img-fluid" alt="Pharmacy Image" width="2000" height="2000">
      </div>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaCompany - Abdul kalaam K M (212223230003).</p>
  </footer>
...
<body>
  ...
  <!-- Navbar -->
  <nav class="navbar navbar-expand-lg navbar-dark bg-success">
    <a class="navbar-brand" href="#">Ak PHARMACEUTICALS</a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="c:\Users\admin\Downloads\m2.jpeg" class="card-img-top" alt="Product 1">
            <div class="card-body">
          ...
          <div class="card">
            <img src="c:\Users\admin\Downloads\m3.jpeg" class="card-img-top" alt="Product 2">
            <div class="card-body">
          ...
          <div class="card">
            <img src="c:\Users\admin\Downloads\m1.jpeg" class="card-img-top" alt="Product 3">
            <div class="card-body">
...
<body>
  ...
  <!-- Navbar -->
  <nav class="navbar navbar-expand-lg navbar-dark bg-success">
    <a class="navbar-brand" href="#">Ak PHARMACEUTICAL</a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-4">
        <h2>Ak PHARMACEUTICAL</h2>
        <address>
          <strong>Address:</strong><br>
          near kovai street,chennai<br>
          <br>
          <strong>Email:</strong><br>
          ak.pharma@gmail.com<br><br>
